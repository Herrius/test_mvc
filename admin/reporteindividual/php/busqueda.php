...
$user_id=null;
$sql1= "select * from tblresultados where idresultado like '%$_GET[s]%' or codestudiante like '%$_GET[s]%'";
	...
	<div class="container">
           <br>
            <div class="card">
               ...
               <a data-idresultado="<?php echo $r["idresultado"];?>" class="btn btn-edit btn-sm btn-dark" style="font-size=40px;">Obtener Reporte</a>                  
            </div><br>
        </div><br>
<?php endwhile;?>
<?php else:?>
